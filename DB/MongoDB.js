...
async function initializeDatabase() {
    try {
        ...
        await db.collection('usuarios').insertOne({...usuariosStructure, user:'adm', password:'adm'});
...
async function addUser(user, password) {
    try {
        await db.collection('usuarios').insertOne({...usuariosStructure, user, password});
